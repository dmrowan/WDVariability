...
def move(i):
    ...
    objecttype = input("Enter category to move to: Pulsator, KnownPulsator, PossiblePulsator, or Eclipse --- ")
    valid_object_types = ["Pulsator", "KnownPulsator","PossiblePulsator", "Eclipse"]
    if not (objecttype in valid_object_types):
        ...
        if os.path.isdir("../InterestingSources/"+objecttype+"/"+source):
            ...
            if not os.path.isdir("../InterestingSources/"+objecttype+"/"+source+'/PDFs'):
                subprocess.run(['mkdir', '../InterestingSources/'+objecttype+'/'+source+'/PDFs'])
        else:
        ...
        subprocess.run(['cp', pdffilename, '../InterestingSources/'+objecttype+"/"+source+"/PDFs/"])
